...
// general images
  ...
  // Banners
  static String banner1 = "$bannersImagesPath/Banner3.jpg";
  static String banner2 = "$bannersImagesPath/banner4.jpg";


  // Categories path

  // static String mobiles = "$categoriesImagesPath/mobiles.png";
  static String mobiles = "$categoriesImagesPath/sunglasses-1.png";

  // static String fashion = "$categoriesImagesPath/fashion.png";
  static String fashion = "$categoriesImagesPath/contact-lenses.png";

  // static String watch = "$categoriesImagesPath/watch.png";
  static String watch = "$categoriesImagesPath/Kids.png";

  // static String book = "$categoriesImagesPath/book_img.png";
  static String book = "$categoriesImagesPath/cleaning-kit.png";

  // static String electronics = "$categoriesImagesPath/electronics.png";
  static String electronics = "$categoriesImagesPath/computerglass.png";

  // static String cosmetics = "$categoriesImagesPath/cosmetics.png";
  static String cosmetics = "$categoriesImagesPath/cosmetics.png";

  // static String shoes = "$categoriesImagesPath/shoes.png";
  static String shoes = "$categoriesImagesPath/Lenses.png";

  // static String pc = "$categoriesImagesPath/pc.png";
  static String pc = "$categoriesImagesPath/spectacles.png";
}
